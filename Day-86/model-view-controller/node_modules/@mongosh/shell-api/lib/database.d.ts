...
import { type ChangeStreamOptions, type CommandOperationOptions, type CreateCollectionOptions, type Document, type WriteConcern, type ListCollectionsOptions } from '@mongosh/service-provider-core';
import { AggregationCursor, RunCommandCursor, CommandResult } from './index';
import type Session from './session';
import ChangeStreamCursor from './change-stream-cursor';
import type { CreateEncryptedCollectionOptions, CheckMetadataConsistencyOptions, RunCommandOptions } from '@mongosh/service-provider-core';
...
export default class Database extends ShellApiWithMongoClass {
    ...
    _runReadCommand(cmd: Document, options?: CommandOperationOptions): Promise<Document>;
    ...
    runCommand(cmd: string | Document, options?: RunCommandOptions): Promise<Document>;
    ...
    killOp(opId: number | string): Promise<Document>;
