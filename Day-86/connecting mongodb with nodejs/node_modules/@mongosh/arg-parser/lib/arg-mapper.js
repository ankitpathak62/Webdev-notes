...
function setServerApi(i, key, value) {
    ...
    const serverApi = typeof previousServerApi === 'string'
        ? { version: previousServerApi }
        : (_a = { ...previousServerApi }) !== null && _a !== void 0 ? _a : {};
    serverApi[key] = value;
...
function setUrlParam(i, key, value) {
    const connectionString = new mongodb_connection_string_url_1.ConnectionString(i.connectionString, {
...
function setAuthMechProp(i, key, value) {
    ...
    const authMechanismProps = new mongodb_connection_string_url_1.CommaAndColonSeparatedRecord(connectionString
        .typedSearchParams()
...
function validateConnectionInfoAfterArgMapping(info, originalOptions) {
    ...
    const connectionString = new mongodb_connection_string_url_1.ConnectionString(info.connectionString, {
        looseValidation: true,
    });
