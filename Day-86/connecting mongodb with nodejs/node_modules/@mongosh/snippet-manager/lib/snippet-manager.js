...
const indexFileSchema = joi_1.default.object({
    indexFileVersion: joi_1.default.number().integer().max(1).required(),
...
class SnippetManager {
    constructor({ installdir, instanceState, skipInitialIndexLoad, }) {
    ...
    async fetch(url) {
        const fetch = await (0, import_node_fetch_1.default)();
