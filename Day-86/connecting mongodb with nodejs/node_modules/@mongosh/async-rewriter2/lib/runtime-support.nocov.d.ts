declare class TypedArray {
    ...
    map: <U_2>(callbackfn: (value: any, index: number, array: any[]) => U_2, thisArg?: any) => U_2[];
    some: (predicate: (value: any, index: number, array: any[]) => unknown, thisArg?: any) => boolean;
    every: {
        <S_1 extends any>(predicate: (value: any, index: number, array: any[]) => value is S_1, thisArg?: any): this is S_1[];
